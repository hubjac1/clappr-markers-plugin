...
/***/ (function(module, exports, __webpack_require__) {
	...
	_this3.core.mediaControl.container.seek(marker.time);e.preventDefault();e.stopImmediatePropagation();});debugger;console.log('ici');console.log($marker);console.log(this._$markers);this._$markers.appendChild($marker);// tooltip
	var $tooltip=marker.$tooltip;if($tooltip){debugger;console.log('there is a tooltip');// there is a tooltip
...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 */var CropMarker=function(_BaseMarker){_inherits(CropMarker,_BaseMarker);/*
	   ...
	   */function CropMarker(time,duration){_classCallCheck(this,CropMarker);var _this=_possibleConstructorReturn(this,(CropMarker.__proto__||Object.getPrototypeOf(CropMarker)).call(this,time));_this._duration=duration||5;_this.externalBuildMarker=null;return _this;}/*
	...
	this._renderDuration(this._duration);this._renderTime(this._time);}/*
		 ...
		 */},{key:'setTime',value:function setTime(time){if(this._time!==time){this._renderTime(time);this._time=time;}}},{key:'_buildMarkerEl',value:function _buildMarkerEl(){var _this2=this;if(this.externalBuildMarker){return this.externalBuildMarker();}else{var $marker=(0,_clappr.$)('<div />').addClass('crop-marker');$marker.append((0,_clappr.$)('<div id="wgrip"/>').addClass('crop-marker-handle').addClass('ui-resizable-handle').addClass('ui-resizable-w').addClass('left'));$marker.append((0,_clappr.$)('<div id="egrip"/>').addClass('crop-marker-handle').addClass('ui-resizable-handle').addClass('ui-resizable-e').addClass('right'));jQuery($marker[0]).resizable({handles:{'w':'#wgrip','e':'#egrip'},resize:function resize(event,ui){ui.originalElement.css({'left':''+1.0*ui.position.left/ui.originalElement.parents('.bar-container').width()*100.0+'%','width':''+1.0*ui.size.width/ui.originalElement.parents('.bar-container').width()*100.0+'%'});_this2._updateDurationValueFromCss();_this2._updateTimeFromCss();},maxHeight:20,minHeight:20});return $marker[0];}}}]);return CropMarker;}(_baseMarker2.default);exports.default=CropMarker;module.exports=exports['default'];
